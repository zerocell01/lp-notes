...
hero:
  title: Ananta Notes
  tagline: Catatan perjalanan belajar Web3 dari nol mencakup dasar Blockchain, Smart Contract dengan Solidity, (DeFi), Token dan NFT, Liquidity Provider, hingga tools yang digunakan developer Web3 sehari-hari.
  image:
    file: ../../assets/x-profile.svg
  actions:
    - text: GitHub
...
Catatan perjalanan belajar Web3 dari nol mencakup dasar Blockchain, Smart Contract dengan Solidity, (DeFi), Token dan NFT, Liquidity Provider , hingga tools yang digunakan developer Web3 sehari-hari.
