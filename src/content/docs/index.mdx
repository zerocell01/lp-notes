...
<div class="hero-profile">
  <img class="hero-profile-avatar" src="../../assets/ananta-avatar.jpg" alt="Ananta" width="80" height="80" loading="eager" />
  <div class="hero-profile-text">
    <span class="hero-profile-name">Ananta</span>
    <span class="hero-profile-handle">@anantachill</span>
    <span class="hero-profile-bio">LP on Meteora, DeFi, Airdrop, etc.</span>
  </div>
</div>
